...
Script to plyaback white gaussian noise from the Vifa speakers at 2m distances
...
triangle_window=scipy.signal.triang(2*rampsamples)

windowed_noise=np.copy(hp_filt_gaussiannoise)

windowed_noise[0:rampsamples]=triangle_window[0:rampsamples]*raw_gaussiannoise[0:rampsamples]
windowed_noise[-rampsamples:playbacksamples]=triangle_window[-rampsamples:2*rampsamples]*raw_gaussiannoise[-rampsamples:playbacksamples]
...
if __name__=='__main__':
    ...
    targetdir='C:\\Users\\tbeleyur\\Documents\\speaker_directionality_measurements\\2m_dist_playbacks\\'
